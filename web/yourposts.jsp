<%-- 
    Document   : yourposts
    Created on : 19.06.2023., 15:04:41
    Author     : Ivan
--%>
...
if (auth == null) {
    ...
    return;
     ...
     String queryPosts="";
     if (auth.getId()==8) {
                 queryPosts = "SELECT * FROM Post INNER JOIN _User ON Post.IDUser = _User.UserID  INNER JOIN UserInfo ON _User.UserID = UserInfo.IDUser";
         }else{     
          queryPosts = "SELECT * FROM Post INNER JOIN _User ON Post.IDUser = _User.UserID  INNER JOIN UserInfo ON _User.UserID = UserInfo.IDUser where _User.LoginName = '" + auth.getUsername() + "'";
     }
 ...
 <div class="container h-100">
  ...
  <div class="card-body">
    ...
    <div class="card-footer" style="padding-left: 27%">
      <a href="seePostjsp.jsp?id=<%= p.getPostId()%>" class="btn btn-primary mt-auto" id="btnAdd">Edit post</a>
       <a href="addHashtag.jsp?id=<%= p.getPostId()%>" class="btn btn-primary mt-auto" id="btnAdd">Add hashtag</a>
    </div>
</div>
